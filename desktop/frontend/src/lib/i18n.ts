...
const messages = {
	"en-US": {
		...
		quota: {
			title: "Usage limits",
			description: "Current ChatGPT Codex rate limits from a manual refresh or opt-in automation.",
			notLoaded: "Limits not checked",
			...
			authRequiredDescription: "Codex rejected the saved access token. Use this Profile in Codex or sign in again, save the current state, and retry.",
		...
		settings: {
			title: "Settings",
			description: "Global desktop preferences.",
			unsupportedToolTitle: "Tool settings are not available",
			unsupportedToolDescription: "ProfileDeck does not yet provide dedicated settings for {agent}.",
			language: {
				label: "Language",
	...
	"zh-CN": {
		...
		quota: {
			title: "使用限额",
			description: "通过手动刷新或显式启用的自动任务读取当前 ChatGPT Codex 限额。",
			notLoaded: "尚未检查限额",
			notLoadedTitle: "尚未检查使用限额",
			notLoadedDescription: "点击刷新，读取此登录状态当前的使用限额。",
			authRequired: "需要刷新登录状态",
			authRequiredDescription: "Codex 拒绝了已保存的 access token。请在 Codex 中使用此 Profile，或重新登录并保存当前状态后重试。",
		...
		settings: {
			title: "设置",
			description: "全局桌面端偏好设置。",
			unsupportedToolTitle: "暂不支持此工具的设置",
			unsupportedToolDescription: "ProfileDeck 尚未提供 {agent} 的独立设置。",
			language: {
				label: "语言",
