<script lang="ts">
	...
	const findingCopyByID: Record<string, string> = {
		...
		grok_build_profile_check_failed: "grokBuildProfileDataUnavailable",
		grok_build_login_invalid: "grokBuildLoginUnavailable",
		grok_build_config_set_invalid: "grokBuildSettingsUnavailable",
		...
		grok_build_auth_target_permissions_weak: "grokBuildLoginPermissions",
		grok_build_auth_target_permission_check_failed: "permissionsCheckFailed",
