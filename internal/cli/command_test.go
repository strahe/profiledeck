...
func TestNewCommandBuildsRootCommand(t *testing.T) {
	...
	codexCommand := cmd.Command("codex")
	if codexCommand == nil || codexCommand.Command("profile") == nil ||
		codexCommand.Command("profile").Command("list") == nil ||
		codexCommand.Command("profile").Command("show") == nil ||
		codexCommand.Command("profile").Command("create") == nil ||
		codexCommand.Command("profile").Command("fork") == nil ||
		codexCommand.Command("profile").Command("save-current") == nil ||
		codexCommand.Command("profile").Command("set-config") == nil ||
		codexCommand.Command("profile").Command("delete") == nil ||
	...
	if codexProfileCommand.Command("export") != nil || codexProfileCommand.Command("import") != nil {
		t.Fatalf("Codex Profile transfer commands must not be registered")
	}
